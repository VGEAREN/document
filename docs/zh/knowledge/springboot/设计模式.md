...
![ioc-patterns](docs/zh/java/springboot/images/ioc-patterns.png)
...
![SpringAOPProcess](docs/zh/java/springboot/images/SpringAOPProcess.jpg)
...
![ApplicationEvent-Subclass](docs/zh/java/springboot/images/ApplicationEvent-Subclass.png)
...
![装饰者模式示意图](docs/zh/java/springboot/images/装饰者模式示意图.jpg)
...
## 出处
[Java Guide](https://javaguide.cn/system-design/framework/spring/spring-design-patterns-summary.html)